...
class TaxReturnsApi
{
    ...
    public function getTaxReturnData($x_api_key, $x_request_id, $id)
    {
        list($response) = $this->getTaxReturnDataWithHttpInfo($x_api_key, $x_request_id, $id);
        return $response;
    }
    
    public function getTaxReturnDataWithHttpInfo($x_api_key, $x_request_id, $id)
    {
        $returnType = 'object';
        $request = $this->getTaxReturnDataRequest($x_api_key, $x_request_id, $id);
        try {
    ...
    public function getTaxReturnDataAsync($x_api_key, $x_request_id, $id)
    {
        return $this->getTaxReturnDataAsyncWithHttpInfo($x_api_key, $x_request_id, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function getTaxReturnDataAsyncWithHttpInfo($x_api_key, $x_request_id, $id)
    {
        $returnType = 'object';
        $request = $this->getTaxReturnDataRequest($x_api_key, $x_request_id, $id);
        return $this->client
    ...
    protected function getTaxReturnDataRequest($x_api_key, $x_request_id, $id)
    {
    ...
    {
        $returnType = '\SatSandboxClientPhp\Client\Model\TaxpayerTaxReturnCollection';
        $request = $this->listTaxpayerTaxReturnRequest($x_api_key, $x_request_id, $id, $operation_number, $type, $interval_unit, $complementary, $capture_line, $period, $presented_at_before, $presented_at_strictly_before, $presented_at_after, $presented_at_strictly_after, $fiscal_year, $order_period, $order_presented_at, $page, $items_per_page);
        try {
            $options = $this->createHttpClientOption();
            try {
                $response = $this->client->send($request, $options);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SatSandboxClientPhp\Client\Model\TaxpayerTaxReturnCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
