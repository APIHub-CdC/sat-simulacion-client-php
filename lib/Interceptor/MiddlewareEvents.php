...
namespace SatSandboxClientPhp\Client\Interceptor;
...
use \SatSandboxClientPhp\Client\Interceptor\KeyHandler;
use \SatSandboxClientPhp\Client\Interceptor\MyLogger;
use \SatSandboxClientPhp\Client\Model\Errors;
use \SatSandboxClientPhp\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\SatSandboxClientPhp\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \SatSandboxClientPhp\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \SatSandboxClientPhp\Client\Model\Errores(["errors" => [$error]]);
